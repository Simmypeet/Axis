...
struct Color
{
    ...
    constexpr static Color<T> GetWhite() noexcept requires(System::IsSame<T, Float32> || System::IsSame<T, Uint8>);

    /// \brief Returns the black color {0, 0, 0, 255}.
    constexpr static Color<T> GetBlack() noexcept requires(System::IsSame<T, Float32> || System::IsSame<T, Uint8>);

    /// \brief Returns the red color {255, 0, 0, 255}.
    constexpr static Color<T> GetRed() noexcept requires(System::IsSame<T, Float32> || System::IsSame<T, Uint8>);

    /// \brief Returns the green color {0, 255, 0, 255}.
    constexpr static Color<T> GetGreen() noexcept requires(System::IsSame<T, Float32> || System::IsSame<T, Uint8>);

    /// \brief Returns the blue color {0, 0, 255, 255}.
    constexpr static Color<T> GetBlue() noexcept requires(System::IsSame<T, Float32> || System::IsSame<T, Uint8>);

    /// \brief Returns the yellow color {255, 255, 0, 255}.
    constexpr static Color<T> GetYellow() noexcept requires(System::IsSame<T, Float32> || System::IsSame<T, Uint8>);

    /// \brief Returns the cyan color {0, 255, 255, 255}.
    constexpr static Color<T> GetCyan() noexcept requires(System::IsSame<T, Float32> || System::IsSame<T, Uint8>);

    /// \brief Returns the magenta color {255, 0, 255, 255}.
    constexpr static Color<T> GetMagenta() noexcept requires(System::IsSame<T, Float32> || System::IsSame<T, Uint8>);

    /// \brief Returns the transparent color {0, 0, 0, 0}.
    constexpr static Color<T> GetTransparent() noexcept requires(System::IsSame<T, Float32> || System::IsSame<T, Uint8>);

    /// \brief Returns the cornflower blue color {100, 149, 237, 255}.
    constexpr static Color<T> GetCornflowerBlue() noexcept requires(System::IsSame<T, Float32> || System::IsSame<T, Uint8>);
};
